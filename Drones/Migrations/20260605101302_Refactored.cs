    ...
    public partial class Refactored : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DroneMaintenanceLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DroneMaintenanceLogs_Drones_DroneId",
                        column: x => x.DroneId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("a1b2c3d4-e5f6-7890-abcd-ef1234567890"), new DateTime(2026, 6, 5, 10, 13, 2, 461, DateTimeKind.Utc).AddTicks(8985), "admin@drones.com", true, true, "$2a$11$7EgxOWPreiRYdOc7OZppf.xILl407QC/8Q4wz887qMba/vk3DniAm", null, null });

            migrationBuilder.InsertData(
                table: "UserRoles",
                columns: new[] { "RoleId", "UserId", "AssignedAt" },
                values: new object[] { 1, new Guid("a1b2c3d4-e5f6-7890-abcd-ef1234567890"), new DateTime(2026, 6, 5, 10, 13, 2, 461, DateTimeKind.Utc).AddTicks(9302) });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DroneMaintenanceLogs_DroneId",
                table: "DroneMaintenanceLogs",
                column: "DroneId");
